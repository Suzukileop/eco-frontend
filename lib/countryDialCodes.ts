export type CountryDialCode = { iso2: string; name: string; dial: string };

/** PNG flag URL (works on Windows; emoji flags often render as ISO letters). */
...
export const COUNTRY_DIAL_CODES: CountryDialCode[] = [
  ...
  { iso2: 'VI', name: 'Virgin Islands (US)', dial: '+1340' },
  { iso2: 'YE', name: 'Yemen', dial: '+967' },
  { iso2: 'ZM', name: 'Zambia', dial: '+260' },
  { iso2: 'ZW', name: 'Zimbabwe', dial: '+263' },
].sort((a, b) => a.name.localeCompare(b.name));

export const DIAL_CODES_BY_LENGTH = [...COUNTRY_DIAL_CODES].sort((a, b) => b.dial.length - a.dial.length);
